...
ADRs registram decisões **duráveis** — as que um agente futuro poderia desfazer por engano. Não crie ADR para detalhe de implementação, escolha de classe CSS, ajuste de conteúdo ou correção de bug.

Formato do arquivo: `ADR-XXX-titulo-curto.md`. Base: `ADR-TEMPLATE.md`.
